<div class="relative" x-data="{ open: false }">
    ...
    <div
        ...
        x-cloak
        class="absolute right-0 z-50 mt-2 w-80 overflow-hidden rounded-xl border border-gray-100 bg-white shadow-lg"
    >
            ...
            @forelse ($this->recentUnreadNotifications as $notification)
                ...
                <li wire:key="notification-{{ $notification->id }}">
                    <button
                        ...
                        class="flex w-full gap-3 px-4 py-3 text-left transition-colors hover:bg-gray-50/80 bg-blue-50/80"
                    >
