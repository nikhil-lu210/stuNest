            ...
            <div class="card-body">
                <form action="{{ route('administration.my.profile.update') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        @else
                            <img src="{{ file_exists(public_path('assets/img/no_image.svg')) ? asset('assets/img/no_image.svg') : 'https://placehold.co/400?text=No+Image' }}" alt="{{ $user->name }} No Avatar" class="d-block w-px-100 h-px-100 rounded" id="uploadedAvatar">
                        @endif
