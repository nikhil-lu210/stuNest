    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="space-y-6 lg:col-span-2">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div class="flex flex-col gap-4 sm:flex-row sm:items-start">
                    @if ($avatarUrl)
                        <img src="{{ $avatarUrl }}" alt="" class="h-16 w-16 shrink-0 rounded-full border border-gray-100 object-cover">
                    @else
                        <div class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full border border-gray-100 bg-gray-100 text-lg font-bold text-gray-600">
                            {{ $initials !== '' ? $initials : '?' }}
                        </div>
                    @endif
                    <div class="min-w-0 flex-1 space-y-3">
                        <div>
                            <p class="text-lg font-bold text-gray-900">{{ $student?->name ?: $student?->email }}</p>
                ...
                <div class="flex flex-col gap-4 md:flex-row md:items-start">
                    ...
                    <div class="min-w-0 flex-1 space-y-2">
                        ...
                        <p class="text-sm text-gray-800">
                            <span class="font-semibold text-gray-900">{{ __('Landlord') }}:</span>
        ...
        <div class="space-y-6 lg:col-span-1">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <a
                    href="{{ route('client.institute.messages.index', ['student_id' => $application->user_id]) }}"
                    wire:navigate
                    class="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white py-2.5 text-sm font-semibold text-gray-900 transition-colors hover:bg-gray-50"
                >
